...
for (i = 0; i < starWarsCharacters.length; i++) {
  const persoStarWars = starWarsCharacters[i].name;
  charactersNames.push(persoStarWars);
}
...
for (i = 0; i < starWarsCharacters.length; i++) {
  const persoStarWars = starWarsCharacters[i];
  if (persoStarWars.gender === "female") {
    femaleCharacters.push(persoStarWars);
  }
}
...
while (f < starWarsCharacters.length) {
  crewMass = crewMass + starWarsCharacters[f].mass;
  f++;
}
...
*/
for (i = 0; i < starWarsCharacters.length; i++) {
  const roboGender = starWarsCharacters[i];
  if (roboGender.gender === "n/a") {
...
*/
console.log("Personaggi prima ", charactersNames.length);
...
console.log("Personaggi dopo  ", charactersNames.length);
